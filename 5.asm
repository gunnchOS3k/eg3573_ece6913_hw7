...
main:
    li a0, 1          # a0 will hold the current term, starting with a0 = 1
    li s0, 0          # s0 will hold our sum of terms, initialized to 0
    li t0, 3          # t0 holds the common difference d = 3
...
loop:
    ...
    add a0, a0, t0    # Calculate the next term: current term + difference
